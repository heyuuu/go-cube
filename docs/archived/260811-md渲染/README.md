...
> **依赖**：
> - [`260811-server后台常驻与HTTP管理`](../archived/260811-server后台常驻与HTTP管理/)（已落地；原「按需启动」提案实施时改为显式 start，`cube md` 需处理「server 未跑」场景）
> - [`260811-前端栈迁移`](../archived/260811-前端栈迁移/)（渲染页面归属前端工程）
